  ...
  public function save(array $form, FormStateInterface $form_state): int {
    ...
    switch ($result) {
      case SAVED_NEW:
        ...
        $this->logger('heart_custom_entities')->notice('New events %label has been created.', $logger_args);
        break;

      case SAVED_UPDATED:
        $this->messenger()->addStatus($this->t('The events %label has been updated.', $message_args));
        $this->logger('heart_custom_entities')->notice('The events %label has been updated.', $logger_args);
        break;
